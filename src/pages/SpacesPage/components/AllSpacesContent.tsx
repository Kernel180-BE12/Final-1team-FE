              ...
              return (
                <React.Fragment key={space.spaceId}>
                  <ListItem
                    ...
                    secondaryAction={
                      // ★★★★★ 수정된 부분 ★★★★★
                      // 현재 사용자의 스페이스 권한이 'ADMIN'이 아닐 경우,
                      // '더보기' 버튼을 비활성화하여 수정 및 삭제를 막습니다.
                      <IconButton
                        edge="end"
                        aria-label="more-actions"
                        onClick={(e) => handleItemMenuOpen(e, space.spaceId)}
                        disabled={space.authority !== 'ADMIN'}
                      >
                        <MoreVertIcon />
                      </IconButton>
                    }
                  >
                    <Box 
                      sx={{ 
                        width: 10, height: 10, borderRadius: '50%', 
                        backgroundColor: space.color || '#ccc',
                        mr: 1.5, border: '1px solid rgba(0,0,0,0.1)'
                      }} 
                    />
                    <ListItemAvatar>
